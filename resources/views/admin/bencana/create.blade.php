...
@section('content')
    ...
    <div class="row">
        <div class="col-lg">
            <form action="{{ route('data-bencana.store') }}" method="POST">
                @csrf
                <div class="card">
                                    ...
                                    <select name="lokasi_id" class="form-control @error('lokasi_id') is-invalid @enderror"
                                        ...
                                        @foreach ($lokasis as $data)
                                            <option value="{{ $data->id }}"
                                                {{ old('lokasi_id') == $data->id ? 'selected' : '' }}>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama_bencana"
                                        ...
                                        value="{{ old('nama_bencana') }}" placeholder="Masukan nama bencana">
                                    @error('nama_bencana')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="penyebab" class="form-control @error('penyebab') is-invalid @enderror" rows="5"
                                        placeholder="Masukan keterangan">{{ old('penyebab') }}</textarea>
                                    @error('penyebab')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
