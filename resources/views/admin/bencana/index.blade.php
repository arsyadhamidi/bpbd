        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('data-bencana.create') }}" class="btn btn-primary">
...
@push('custom-script')
    <script>
        $(document).ready(function() {
            ...
            var editRoute = "{{ route('data-bencana.edit', ':id') }}"
            var deleteRoute = "{{ route('data-bencana.destroy', ':id') }}";
            ...
            function format(d) {
                ...
                return '<table>' +
                    '<tr>' +
                    '<td>Edit Data Bencana :</td>' +
                    '<td><a href="' + editUrl +
                    '"class="btn btn-info"><i class="fa fa-edit"></i> &nbsp; Edit Data Bencana</a></td>' +
                    '</tr>' +
                    '<tr>' +
                    '<td>Hapus Data Bencana</td>' +
                    '<td><form action="' + deleteUrl + '" method="POST" id="dataForm">' +
                    '@csrf' +
                    '<button type="submit" class="btn btn-danger" id="hapusData"><i class="fa fa-times"></i> &nbsp; Hapus Data Bencana</button>' +
                    '</form></td>' +
                    '</tr>' +
                    '</table>';
            }
