        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('data-galeri.create') }}" class="btn btn-primary">
...
@push('custom-script')
    <script>
        $(document).ready(function() {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            if (data) {
                                // Buat URL foto dengan path `storage` dan path foto dari data
                                const photoUrl = `${location.origin}/storage/${data}`;
                                return `<img src="${photoUrl}" alt="foto bencana" style="width: 70px; height: 70px;margin-right: 5px;" />`;
                            }
                            return '-';
                        }
                    }
            ...
            var editRoute = "{{ route('data-galeri.edit', ':id') }}"
            var deleteRoute = "{{ route('data-galeri.destroy', ':id') }}";
            ...
            function format(d) {
                ...
                return '<table>' +
                    '<tr>' +
                    '<td>Edit Data Galeri :</td>' +
                    '<td><a href="' + editUrl +
                    '"class="btn btn-info"><i class="fa fa-edit"></i> &nbsp; Edit Data Galeri</a></td>' +
                    '</tr>' +
                    '<tr>' +
                    '<td>Hapus Data Galeri</td>' +
                    '<td><form action="' + deleteUrl + '" method="POST" id="dataForm">' +
                    '@csrf' +
                    '<button type="submit" class="btn btn-danger" id="hapusData"><i class="fa fa-times"></i> &nbsp; Hapus Data Galeri</button>' +
                    '</form></td>' +
                    '</tr>' +
                    '</table>';
            }
